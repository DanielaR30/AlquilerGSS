...
namespace AlquilerGSS.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public CarroesController(GSSContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Idcarro,Placa,Marca,Modelo,Costo,Disponible")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idcarro,Placa,Marca,Modelo,Costo,Disponible")] Carro carro)
        {
            if (id != carro.Idcarro)
            {
                return NotFound();
